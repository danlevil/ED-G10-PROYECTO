 ...
 * @author Charlie
 */
public class ListaFiltroContactoFavoritoController implements Initializable {
    ...
    private FiltradorFavoritos f2;
    private List<Contacto> solofavs;
    /**
     * Initializes the controller class.
     */
    public void initialize(URL url, ResourceBundle rb) {
        f2= new FiltradorFavoritos();

        solofavs= f2.filtrarSoloFavoritos(Agenda.contactosMaster);
    ...
    private void avanzarIzquierda(MouseEvent event) {
        ...
        int totalPaginas = (int) Math.ceil((double) solofavs.size() / ELEMENTOS_POR_PAGINA);
