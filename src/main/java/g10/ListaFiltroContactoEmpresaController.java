 ...
 * @author Charlie
 */
    public class ListaFiltroContactoEmpresaController implements Initializable {
    ...
    private FiltradorEmpresas f3;
    private List<Contacto> soloEmpresas;

    /**
     * Initializes the controller class.
     */
    public void initialize(URL url, ResourceBundle rb) {
        f3= new FiltradorEmpresas();

        soloEmpresas= f3.filtrarSoloEmpresas(Agenda.contactosMaster);
    ...
    private void avanzarIzquierda(MouseEvent event) {
        ...
        int totalPaginas = (int) Math.ceil((double) soloEmpresas.size() / ELEMENTOS_POR_PAGINA);
